...
function hitung() {
  ...
  document.getElementById("hasilnettbundle").innerHTML =
    "Rp. " + hasilnettbundle.toFixed(2) + " /bundle";
  document.getElementById("hasilnettunit").innerHTML =
    "Rp. " + hasilnettunit.toFixed(2) + " /unit";
}
